...
TARGET_VERSION :=
TARGET_PLUGINS := github.com/launchrctl/compose@v0.10.1,github.com/launchrctl/keyring@v0.2.6,github.com/launchrctl/launchr@v0.16.4,github.com/launchrctl/web@v0.11.1,github.com/skilld-labs/plasmactl-bump/v2@v2.0.7,github.com/skilld-labs/plasmactl-dependencies@v0.3.5,github.com/skilld-labs/plasmactl-meta@v0.10.2,github.com/skilld-labs/plasmactl-package@v1.1.1,github.com/skilld-labs/plasmactl-publish@v1.3.3,github.com/skilld-labs/plasmactl-update@v0.2.3
