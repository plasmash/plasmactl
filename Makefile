...
TARGET_VERSION :=
TARGET_PLUGINS := github.com/launchrctl/compose@v0.8.0,github.com/launchrctl/keyring@v0.2.3,github.com/launchrctl/launchr@v0.9.0,github.com/launchrctl/web@v0.0.2,github.com/skilld-labs/plasmactl-bump@v1.7.2,github.com/skilld-labs/plasmactl-dependencies@v0.2.0,github.com/skilld-labs/plasmactl-meta@v0.7.0,github.com/skilld-labs/plasmactl-package@v1.1.0,github.com/skilld-labs/plasmactl-publish@v1.3.2,github.com/skilld-labs/plasmactl-update@v0.2.2
