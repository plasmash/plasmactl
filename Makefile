...
TARGET_VERSION :=
TARGET_PLUGINS := github.com/launchrctl/compose@v0.14.0,github.com/launchrctl/keyring@v0.3.2,github.com/launchrctl/launchr@v0.18.0,github.com/launchrctl/web@v0.12.4,github.com/skilld-labs/plasmactl-bump/v2@v2.5.0,github.com/skilld-labs/plasmactl-dependencies@v0.4.0,github.com/skilld-labs/plasmactl-meta@v0.16.1,github.com/skilld-labs/plasmactl-package@v1.2.0,github.com/skilld-labs/plasmactl-publish@v1.4.0,github.com/skilld-labs/plasmactl-release@v1.0.0,github.com/skilld-labs/plasmactl-update@v0.3.0
