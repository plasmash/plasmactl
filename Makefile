...
TARGET_VERSION :=
TARGET_PLUGINS := github.com/launchrctl/launchr@v0.8.1,github.com/launchrctl/keyring@v0.2.2,github.com/launchrctl/compose@v0.8.0,github.com/skilld-labs/plasmactl-bump@v1.7.1,github.com/skilld-labs/plasmactl-package@1.1.0,github.com/skilld-labs/plasmactl-publish@1.3.1,github.com/skilld-labs/plasmactl-meta@v0.6.1,github.com/skilld-labs/plasmactl-update@v0.2.2,github.com/skilld-labs/plasmactl-dependencies@v0.1.0
