...
TARGET_VERSION :=
TARGET_PLUGINS := github.com/launchrctl/launchr@latest,github.com/launchrctl/compose@latest,github.com/skilld-labs/plasmactl-bump@latest,github.com/skilld-labs/plasmactl-package@latest,github.com/skilld-labs/plasmactl-publish@latest,github.com/skilld-labs/plasmactl-meta@v0.2.0
