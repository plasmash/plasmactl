...
TARGET_VERSION :=
TARGET_PLUGINS := github.com/launchrctl/compose@v0.14.0,github.com/launchrctl/keyring@v0.4.0,github.com/launchrctl/launchr@v0.20.1,github.com/launchrctl/web@v0.14.0,github.com/skilld-labs/plasmactl-bump/v2@v2.6.0,github.com/skilld-labs/plasmactl-dependencies@v0.4.1,github.com/skilld-labs/plasmactl-meta@v0.16.1,github.com/skilld-labs/plasmactl-package@v1.2.0,github.com/skilld-labs/plasmactl-publish@v1.4.0,github.com/skilld-labs/plasmactl-release@v1.1.0,github.com/skilld-labs/plasmactl-update@v1.0.0
